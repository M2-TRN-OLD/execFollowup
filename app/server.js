...
const app = express();  // initialize Express server by creating the variable app to represent the application

// MIDDLEWARE
app.use(morgan('common'));  // allows Morgan to intercept and log all HTTP requests to the console
app.use(express.json());  //required to fetch request JSON data payload can be parsed and saved into request.body
